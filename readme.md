...
These parameters must be configured based on the recipe website
    ...
    4. listing: How each of the items in the seeds are listed. Listing has 2 parameters:
        ...
        For this next there are various types developed to handle different recipe website types:
            ...
            2. url: the most common recipe website type. In this type, Spider will go through each page iteratively until the max_page (if specified in the spider).


            3. custom_modify_url: UNUSED. Initially developed to scrape justfood.tv. But was unused since the website has tough security (datadome).

            4. one_page: MOSTLY UNUSED if the website does not have any other pages. Case: Ireland website Delish.com

    5. OPTIONAL PARAMETERS: Headers
